...
{
    class AwesomiumResourceHandler : IResourceInterceptor
    {
        const string LocalRequestUrlBase = "local://base_request.html/";
        public static AwesomiumHost Host { get; set; }

        private AwesomiumResourceHandler() { }

        public static IResourceInterceptor ResourceInterceptor
        {
            get { return new AwesomiumResourceHandler(); }
        }
