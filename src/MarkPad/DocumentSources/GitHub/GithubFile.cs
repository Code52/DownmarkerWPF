...
{
    public class GithubFile : MarkpadDocumentBase
    {
        readonly IGithubApi github;
        readonly GithubSiteContext siteContext;
        readonly List<string> imagesToSaveOnPublish = new List<string>();
        Post post;

        public GithubFile(BlogSetting blog, Post post, 
            IDocumentFactory documentFactory,
            GithubSiteContext siteContext,
            IGithubApi github) :
